<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReleaseWaiver.aspx.cs" Inherits="EmailTemplates_ReleaseWaiver" %>
...
<body>
    ...
    <div class="page">
        ...
        <div class="main">
            ...
            <p>We have been asked that each presenter (speaker, technincal panel moderator/panelist, poster presenter) 
            at the 2015 Engineering Conference
            submit a signed "Individual Appearance Release" agreement. This is the same agreement
            to which you have already agreed when you registered for the conference. Please take
            moment to print out and read the attached release.</p> 
            <p><u>Please sign and return a signed
            release to Dan Stauffer via soft-copy scan or through inter-office mail.</u> (Email:
            <a href='mailto:Daniel.Stauffer@kla-tencor.com'>Daniel.Stauffer@kla-tencor.com</a>, 
                mailstop: 1216-145).</p>
            <p> We apologize for the inconvenience; this was a late-notice requirement and we did not have the chance to get all presenters
            at the conference to sign a release.</p>
            <p> Regards, <br />
