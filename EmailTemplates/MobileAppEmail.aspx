<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MobileAppEmail.aspx.cs" Inherits="MobileAppEmail" %>
    ...
    <div class="page">
        ...
        <div class="main">
            <div style="margin-bottom: 10px">
                <h1>
                    The 2015 Engineering Conference has Gone mobile!</h1>
            </div>
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px">
                                                    <div style="margin-top: 10px">
                                                        <h3>
                                                            We&#39;ve created a mobile app for the 2015 Engineering Conference!</h3>
                                                        <br />
                                                        <div style="margin-top: 5px">
                                                            <b>To Use the KLA-Tencor Corporate Events App:</b>
                                                            <table style="width: 800px">
                                                                <tr>
                                                                    <td style="padding-left: 25px; padding-top:5px">
                                                                        1. Visit the appropriate app store and download:
                                                                        <table>
                                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-left: 25px; padding-top:5px">
                                                                        2. Open the KLA-Tencor Events App and select the '2015 Engineering Conference -
                                                                        Accelerate Innovation' event.
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding-left: 25px; padding-top:5px">
                                                                        3. When prompted enter the event code: <strong>kteng</strong> 
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding-left: 25px; padding-top:5px">
                                                                        <span>4. Log in to enjoy the full features of the app using your KT email address and
                                                                            your confirmation code:&nbsp; </span>
                                                                        <asp:Label ID="lbl_ConfirmationCode" runat="server" Font-Bold="true" Text="XXXXXXXXX" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding-left: 25px; padding-top: 10px">
                                                                        <i>Note: If your download stalls, you may need to delete the app and download again.
                                                                            We&#39;re working with the vendor, but this is their recommended workaround. It
                                                                            normally fixes the problem.</i>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                        <br />
                                                        <strong>With the app, you can:</strong>
                                                        <ul>
