<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InviteReminder.aspx.cs" Inherits="EmailTemplates_InviteReminder" %>
...
<body>
    ...
    <div class="main">
        ...
        ,<p>
            We have not received your registration for the 2015 Engineering Conference.</p>
        <p>
            <span style='color: red; display:none'><u>Please register before 
                <asp:Label ID="lbl_RegistrationEndDate" runat="server" Text="Label"></asp:Label> as late registrations may not be accepted. 
                After the registration deadline, unused invitations
                 may be reassigned to other engineers.</u></span>
        </p>
         <p>
            You can register at the following webpage: <a href='http://chief-engineer/EngineeringConference/Registration/'>
                Engineering Conference Registration Site</a>.</p>
        <p>
            Seats are filling up fast in some of the Technical Panels and White Paper Symposia.
            As a reminder, seat allocations will be made on a first-come, first-served basis.</p>
        <p>
            <u>If you are unable to attend the conference, please visit the registration site and
                click the 'Decline' button.</u></p><p>
        If you are having difficulty registering,
            please contact <a href='mailto:Daniel.Stauffer@kla-tencor.com'>Dan Stauffer, Corp PLC.</a></p>
        <p>
            Regards,<br>
